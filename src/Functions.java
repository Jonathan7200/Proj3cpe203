...
//            scheduleEvent(scheduler, action.entity, createAnimationAction(action.entity, Math.max(action.repeatCount - 1, 0)), action.getEntity().getAnimationPeriod());
//        }
//    }
...
//        switch (entity.kind) {
//            case DUDE_FULL:
//                scheduler.scheduleEvent(entity, Action.createActivityAction(entity, world, imageStore), entity.actionPeriod);
//                scheduler.scheduleEvent(entity, Action.createAnimationAction(entity, 0), entity.getAnimationPeriod());
//                break;
//
//            case DUDE_NOT_FULL:
//                scheduler.scheduleEvent(entity, Action.createActivityAction(entity, world, imageStore), entity.actionPeriod);
...
//                Point worldPoint = view.viewportToWorld(col, row);
...
//                view.screen.image(entity.getCurrentImage(entity), viewPoint.x * view.tileWidth, viewPoint.y * view.tileHeight);
//            }
//        }
//    }
